...
# Copy only the Client entity definition
cp -r src/Entities/cr2a0_client temp_src/Entities/

# Copy the solution files
cp src/Other/Customizations.xml temp_src/Other/
cp src/Other/Solution.xml temp_src/Other/

# Modify Solution.xml to only include the Client entity
sed -i '' '/cr2a0_debtaccount/d' temp_src/Other/Solution.xml
